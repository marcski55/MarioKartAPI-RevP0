...
export async function updatePart(req, res) {
    ...
    if ('type' in newInfo ||
        ...
        if ('Error' in oldInfo) {
            ...
            const part = new Part(name, 'type' in newInfo ? newInfo.type : oldInfo.PartType.S, 'speed' in newInfo ? newInfo.speed : parseFloat(oldInfo.Speed.N), 'acceleration' in newInfo ?
