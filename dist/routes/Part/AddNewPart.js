 ...
 */
export async function addNewPart(req, res) {
    /** Get Part information and create a new Part object */
    const { name } = req.params;
    const partData = req.body;
    const part = new Part(name, partData.type, partData.speed, partData.acceleration, partData.weight, partData.handling, partData.traction, partData.miniTraction);
